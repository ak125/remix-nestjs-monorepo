		...
		<!-- FORMULAIRE -->      
			...
			<div class="row">
				<div class="col-12 col-sm-6 col-md-9 col-xl-10 pb-3">
					...
					<input type="text" name="MINE" class="subscribe" required autocomplete="off" placeholder="Recherche par type mine" />
					<input type="hidden" name="ASK2PAGE" value="1" />
					
				</div>
				<div class="col-12 col-sm-6 col-md-3 col-xl-2 pb-3 text-right">
					
					<input type="submit" class="subscribeSubmit" value="rechercher" />
