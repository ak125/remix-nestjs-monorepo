...
<link href="/assets/css/style.home.min.css" rel="stylesheet" media="all">
-->
<!-- CSS -->
<style>
...
<a href="<?php echo $thislinktoMQ; ?>">
	<div class="col-12 text-center align-middle catalogFamilyContentPic p-1">
        ...
        <img data-src="<?php echo $this_marque_pic; ?>" src="/upload/loading-min.gif" alt="<?php echo $result_marque['MARQUE_NAME_META']; ?>" title="<?php echo $result_marque['MARQUE_NAME_META']; ?>" class="img-fluid lazy"/>
	...
	?>
		<div class="col-12 col-md-6 blocToPCar">
				...
				<div class="container-fluid regularContentBordered2 mh257 p-3">
					<img data-src="<?php echo $this_pg_pic; ?>" src="/upload/loading-min.gif" alt="<?php echo $result_catalog_gamme['PG_NAME_META']; ?>" title="<?php echo $result_catalog_gamme['PG_NAME_META']; ?>" class="img-fluid lazy"/> 
...
<div class="row p-0 m-0">
	<div class="col-12 text-center align-middle homeequiptxt">
        ...
        <img data-src="<?php echo $this_pm_pic; ?>" src="/upload/loading-min.gif" alt="<?php echo $result_equip['PM_NAME_META']; ?>" title="<?php echo $result_equip['PM_NAME_META']; ?>" class="img-fluid lazy"/>
