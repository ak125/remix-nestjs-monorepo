    ...
    <div class="col-md-7 PAGE-410-CONTENT">
        ...
        <div class="row">
          <div class="col-md-12 PAGE-410-CONTENT-TITLE">
            ...
            <br>Rejet de paiement de commande
          </div>
          <div class="col-md-12 PAGE-410-CONTENT-TXT">
Nous vous remercions pour votre confiance mais nous tenons à vous informer que votre paiement a été refusé.
<br>
...
<br>
Merci de nous contacter en sauvegardant votre numéro de commande <b><?php echo $commandeid; ?></b> si vous avez besoin d'une assistance plus précise.
          </div>
        </div>
    </div>
  </div>
