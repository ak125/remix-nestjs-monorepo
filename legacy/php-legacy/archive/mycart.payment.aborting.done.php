    ...
    <div class="col-md-7 PAGE-410-CONTENT">
        ...
        <div class="row">
          <div class="col-md-12 PAGE-410-CONTENT-TITLE">
            <h1 class="PAGE-410">Commande n&deg; <?php echo $commandeid; ?> non validée</h1>
            <br>Annulation de paiement de commande
          </div>
          <div class="col-md-12 PAGE-410-CONTENT-TXT">
Nous vous remercions pour votre confiance mais nous tenons à vous informer que votre paiement a été annulé.
<br>
Dans ce cas, votre commande numéro <b><?php echo $commandeid; ?></b> sera enregistrée sur votre espace client et vous pourrez effectuer un nouveau paiement dès que possible.
<br>
Code erreur généré :  
Vous avez choisi d'annuler votre commande.
<br>
Si vous n'êtes pas à l'origine de cette annulation, merci de nous contacter en sauvegardant votre numéro de commande <b><?php echo $commandeid; ?></b> et ce pour une assistance plus précise.
          </div>
        </div>
    </div>
  </div>
