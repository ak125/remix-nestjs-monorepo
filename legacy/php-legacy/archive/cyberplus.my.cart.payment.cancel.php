...
// envoi du mail de rejet au client
		...
		$ClientSujet = "Annulation de paiement" ;
		$ClientComAmount = $Mt/100 ;
// envoi du mail de confirmation au client
//SendMailToClientPaymentAborted( $domainname, $domainclientaccount, $domainwebsitecontact, $domainwebsitetel, $ClientMail, $ClientData, $ClientSujet, $Ref );
...
<form name="ConcludeCom" id="ConcludeCom" method="post" action="<?php echo $domain; ?>/mycart.payment.aborting.done.php">  
