...
<div class="col-12">
    ...
    <div class="row">
      ...
      // CART CONTENT
      $qCommandeLine = mysql_query("SELECT * FROM 2027_xmassdoc_commande_line WHERE linecom_com_id = $com_id ");
      while($CommandeLine = mysql_fetch_array($qCommandeLine)) 
      {
      // line commande
      $linecom_id = $CommandeLine['linecom_id'];
...
?>
<?php if ($CommandeLine["linecom_statut"]==1) $sendingforconfirmation = 0; ?>
                    ...
                    <?php 
                    if ($CommandeLine["linecom_statut"]==1)
                    {
                      ?>
                      <a href="<?php echo $domain; ?>/purchaseorder/update/<?php echo $com_id; ?>/<?php echo $linecom_id; ?>/11" class="modal-action-green">Received</a>
                        
                      <a href="<?php echo $domain; ?>/purchaseorder/update/<?php echo $com_id; ?>/<?php echo $linecom_id; ?>/12" class="modal-action-red">Delete</a>
                      <?php
                    }
                    ?>
      ...
      <?php 
      if (($sendingforconfirmation == 1)&&($Commande["com_level"] == 1))
      {
      ?>
      <div class="row mt-2">
          <div class="col-7">
          ...
          <div class="col-5 pt-3 pb-3 text-center">
              ...
              <a href="<?php echo $domain; ?>/purchaseorder/upgrade/<?php echo $com_id; ?>" class="modal-action-upgrade">VALIDATION</a>
