...
if(isset($_POST["insert"]))
{
	...
	$spl_name = mysqli_real_escape_string($conn, $_POST['spl_name']);
	$spl_alias=url_title($spl_name,"-");

	if($spl_name!="")
	{
		//mysqli_set_charset($conn,"utf8");
		$InsertQuery = "INSERT INTO `___XTR_SUPPLIER` (`SPL_ID`, `SPL_NAME`, `SPL_ALIAS`, `SPL_DISPLAY`, `SPL_SORT`) 
			VALUES (NULL, '$spl_name', '$spl_alias', '1', '99')";
...
<body class="BODY-MODAL">
	...
	<div class="row">
		<div class="col-12 text-center pb-3">
			<h2 class="H2-MODAL"><u>Ajouter un fournisseur</u></h2>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-6">
			Nom du fournisseur
			<input name="spl_name" type="text" class="TAKE-ACTION-INPUT" />
		</div>
