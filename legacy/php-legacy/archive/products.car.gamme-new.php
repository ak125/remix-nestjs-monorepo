<?php 
session_start();
// parametres relatifs à la page new
$typefile="composit";
...
<div class="container-fluid pieceContainerin h-100">
	...
	<div class="row p-0 m-0">
		...
		<div class="col-5 align-self-center">
			...
			?>
			<img data-src="<?php echo $domain; ?>/upload/equipementiers-automobiles/<?php echo $this_pm_img; ?>" src="/upload/loading-min.gif" alt="<?php echo $result_item_list['PM_NAME']; ?>" title="<?php echo $result_item_list['PM_NAME']; ?>" class="img-fluid lazy"/>
		</div>
		...
		<div class="col-12 pieceWall">
			<img data-src="<?php echo $domain; ?>/<?php echo $photo_link; ?>" src="/upload/loading-min.gif" alt="<?php echo $photo_alt; ?>" title="<?php echo $photo_title; ?>" class="wall img-fluid lazy"/>
		</div>
		<?php
		}
		?>
...
<!-- / BLOC LIST --><!-- / BLOC LIST --><!-- / BLOC LIST --><!-- / BLOC LIST --><!-- / BLOC LIST --><!-- / BLOC LIST -->
		...
		if ($request_get_cross_gamme->num_rows > 1) 
		{
			...
			<div class="col-12 col-md-6 blocToPCar">
				...
				<div class="container-fluid regularContentBordered2 mh237 p-3">
					<img data-src="<?php echo $this_pg_pic; ?>" src="/upload/loading-min.gif" alt="<?php echo $this_pg_name_meta; ?>" class="img-fluid lazy"/> <?php echo content_cleaner($addon_content_seo_gamme_car); ?>
				</div>
    ...
    WHERE BA_PG_ID = $pg_id AND BA_STATUS = 1
