...
<!-- CSS -->
<link href="<?php echo $domain; ?>/assets/css/v7.style.support.css" rel="stylesheet" media="all">
</head>
<body>
    ...
    <div class="container-fluid mymaxwidth">
		...
		<div class="row">
			...
			<div class="col-12 pt-3 pb-3">
					...
					<div class="row">
						<div class="col-12 col-sm-6 col-md-9 col-xl-10 pb-3">
							
							<input type="text" name="MINE" class="mine" required autocomplete="off" placeholder="Recherche par type mine" />
							<input type="hidden" name="ASK2PAGE" value="1" />
							
						</div>
						<div class="col-12 col-sm-6 col-md-3 col-xl-2 pb-3 text-right">
							
							<input type="submit" class="minesubmit" value="" />
