...
if(isset($_POST["update"]))
{
	...
	$StatusUpdateQuery = "UPDATE ___XTR_ORDER_LINE SET ORL_ORLS_ID = $orls_id, ORL_EQUIV_ID = 0  
		WHERE ORL_ORD_ID = $ord_id AND ORL_ID = $orl_id";
	if($conn->query($StatusUpdateQuery) === TRUE)
	{
		$StatusUpdateResponse = "Traitement et Statut de Pièce réinitialiser avec Succès.";
...
<body class="BODY-MODAL">
	...
	<div class="row">
		<div class="col-lg-12 text-center pb-3">
			...
			<br>
			Cette opération est définitive et irréversible, Merci de confirmer.
		</div>
		<div class="col-lg-12 text-center pt-3">
			<input type="submit" value="Valider la <?php echo $pageAction; ?>" class="TAKE-ACTION-SUBMIT-DELETE-LINK" style="float: none;" />
