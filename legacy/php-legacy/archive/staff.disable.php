...
if(isset($_POST["suspension"]))
{
	...
	$SuspensionQuery = "UPDATE ___CONFIG_ADMIN SET CNFA_ACTIV = 0 WHERE CNFA_ID = $cnfa_id";
...
<body class="BODY-MODAL">
	...
	<div class="row">
		<div class="col-12 text-center pb-3">
			<u><?php echo $pageH1; ?>, Suspendre un vendeur</u>
	...
	<div class="row">
		<div class="col-lg-12 text-center">
			Etes vous sûr de vouloir suspendre ce compte : <b><?php echo $cnfa_name; ?></b>.<br>
			Merci de confirmer.
		</div>
		<div class="col-lg-12 text-center">
			<input type="submit" value="SUSPENDRE" class="TAKE-ACTION-SUBMIT-DELETE-LINK" style="float: none;" />
