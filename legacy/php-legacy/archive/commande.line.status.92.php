...
$ord_id = $_GET["ord_id"];
$orl_id = $_GET["orl_id"];
$orls_id = 92; // ACCEPTATION EQUIVALENCE
...
if(isset($_POST["update"]))
{
	...
	if($conn->query($StatusUpdateQuery) === TRUE)
	{
		...
		//if($conn->query($StatusUpdateQuery) === TRUE)
		//{
			$StatusUpdateResponse = "Proposition d'équivalence acceptée avec Succès.";
...
<body class="BODY-MODAL">
	...
	<div class="row">
		<div class="col-lg-12 text-center pb-3">
			Etes vous sûr de vouloir procéder à l'<b><?php echo $pageAction; ?></b> de cette pièce :<br>
		...
		<div class="col-lg-12 text-center pt-3">
			<input type="submit" value="Valider l'<?php echo $pageAction; ?>" class="TAKE-ACTION-SUBMIT-UPDATE-LINK" style="float: none;" />
