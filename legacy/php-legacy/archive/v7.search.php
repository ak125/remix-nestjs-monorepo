			...
			<div class="col-md-8 col-lg-9 text-left">
				...
				<div class="row">
				    ...
				    <div class="col-12 p-0">
						...
						<div class="flowers">
				        <?php
				        $query_bloc_listing = "SELECT DISTINCT PG_ID, PG_NAME, PG_ALIAS 
							FROM PIECES_REF_SEARCH
							INNER JOIN PIECES ON PIECE_ID = PRS_PIECE_ID  
							INNER JOIN PIECES_GAMME ON PG_ID = PIECE_PG_ID
							WHERE PRS_SEARCH = '$questCleaned' AND PIECE_DISPLAY = 1 AND PG_DISPLAY = 1
				        ...
				        {
				        $filter_pg_id = $result_bloc_listing['PG_ID'];
						$filter_pg_name = $result_bloc_listing['PG_NAME'];
						$filter_pg_alias = $result_bloc_listing['PG_ALIAS'];
				        ...
				        <div class="flower itemsTitle" data-id="<?php echo $filter_flower_id; ?>" data-category="<?php echo $filter_pg_alias; ?>">
				        	...
				        	<h2><?php echo $result_bloc_listing['PG_NAME']; ?></h2>
				        	<div></div>

				        </div>
				        <?php
				        $query_listing = "SELECT DISTINCT PIECE_ID, PIECE_REF, PIECE_NAME, PIECE_NAME_COMP, PIECE_NAME_SIDE, 
					        ...
					        INNER JOIN PIECES_PRICE ON PRI_PIECE_ID = PIECE_ID 		
							INNER JOIN PIECES_MARQUE ON PM_ID = PRI_PM_ID
							WHERE PRS_SEARCH = '$questCleaned' AND PIECE_PG_ID = $filter_pg_id AND PIECE_DISPLAY = 1 
							AND PM_DISPLAY = 1 AND PRI_DISPO = 1 
				        ...
				        $filter_pm_alias = url_title($result_listing['PM_NAME']);
...
<div class="flower" data-id="ref<?php echo $piece_id_this; ?>" data-category="<?php echo $filter_pg_alias; ?> <?php echo $filter_pm_quality_alias; ?> <?php echo $filter_pm_stars_alias; ?> <?php echo $filter_pm_alias; ?>">
				        	...
				        	<div class="itemsBloc">
								...
								<?php
								/*$query_item_list_technical = "SELECT DISTINCT PCL_CRI_ID, PCL_CRI_CRITERIA, PC_CRI_VALUE AS PCL_VALUE, PCL_CRI_UNIT
				                    FROM PIECES_CRITERIA
				                    INNER JOIN PIECES_CRITERIA_LINK ON PCL_CRI_ID = PC_CRI_ID AND PCL_PG_PID = PC_PG_PID
				                    WHERE PC_PIECE_ID = $piece_id_this AND PCL_DISPLAY = 1 AND PC_DISPLAY = 1
