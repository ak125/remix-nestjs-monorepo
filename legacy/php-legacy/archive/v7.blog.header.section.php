...
<div class="container-fluid stickymenu">
    <div class="container-fluid mymaxwidth p-0">
		...
		<a href="" class="mobile-menu-trigger-user"><img src="/assets/img/user.svg" width="27" /></a>
	    ...
	    <ul class="menu menu-bar">
	      ...
	      <li>
	        <a href="<?php echo $domain; ?>/<?php echo $blog; ?>/<?php echo $entretien; ?>" class="menu-link menu-bar-link"><?php echo $entretien_title; ?></a>
	      </li>
	      <li>
	        <a href="<?php echo $domain; ?>/<?php echo $blog; ?>/<?php echo $constructeurs; ?>" class="menu-link menu-bar-link"><?php echo $constructeurs_title; ?></a>
	      </li>
	      <li>
	        <a href="<?php echo $domain; ?>/<?php echo $blog; ?>/<?php echo $guide; ?>" class="menu-link menu-bar-link"><?php echo $guide_title; ?></a>
	      </li>
