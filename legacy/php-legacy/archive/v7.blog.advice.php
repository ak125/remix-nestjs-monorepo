...
// CANONICAL
$canonicalLink = $domain."/".$blog."/".$entretien;
?>
<!doctype html>
			...
			<div class="col-md-8 text-left">
				...
				<div class="row">
					...
					<div class="col-12 pb-3">
						...
						<div class="row pb-3">
						<?php
						$query_advice = "SELECT DISTINCT BA_ID, BA_H1, BA_ALIAS, BA_WALL, BA_PREVIEW, BA_CREATE, BA_UPDATE, 
						...
						while($result_advice = $request_advice->fetch_assoc())
						{
							...
							<div class="col-12 col-md-8 itemsBloc">
									...
									<i>&nbsp; &nbsp; Publié le <?php echo date_format(date_create($result_advice['BA_UPDATE']), 'd/m/Y'); ?></i>
									<p>
