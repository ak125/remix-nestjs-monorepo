        ...
        <div className="md:w-2/3 md:pl-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="flex-1 flex items-center gap-2">
                <Link to="/">
              ...
              <Button variant="outline" asChild size="lg" className="flex-1 flex items-center gap-2">
                <Link to="/blog-pieces-auto">
                  <BookOpen className="w-4 h-4" />
                  <span>Visiter le blog automobile</span>
                </Link>
              </Button>
            </div>
